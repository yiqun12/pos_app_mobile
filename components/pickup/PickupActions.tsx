  ...
  return (
    <View className="gap-3 px-4 py-4">
      <TouchableOpacity
        ...
        onPress={onAddItems}
      >
        <Text style={{ fontSize: responsive.baseFontSize }} className="font-semibold text-blue-500">Add Items</Text>
      </TouchableOpacity>
      ...
      >
        <Text style={{ fontSize: responsive.baseFontSize }} className="font-semibold text-white">
          Complete Order
        </Text>
      </TouchableOpacity>
    </View>
